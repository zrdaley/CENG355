...
int main(int argc, char* argv[])
{
	...
	myGPIOD_Init();		/* Initialize I/O port PD */
	...
	{
		/* poll ADC */
		unsigned int acdValue = readADC();

		/* calculate resistance, output to DAC */
	...
	if ((EXTI->PR & EXTI_PR_PR1) != 0){
	 ...
	 /* If this is the first edge */
		...
		/* If this is the second edge */
			...
			/* Cast freq to a global int for LCD use */
			freq = (int)frequency;
			displayLCD();
		}
...
/* Displays current global freq on LCD */
void displayLCD()
{
	/* Logic for displaying on LCD here */
}

unsigned int readADC()
{
	/* Logic for polling ACD here */
}
